...
> 原为 `archive/gemini-gem/wenxin-spec.md` §10，整体从 [wenxin](../wenxin/README.md) 移至此处
> Originally §10 of `archive/gemini-gem/wenxin-spec.md`, moved wholesale from wenxin to here
...
**灵魂注入 Soul injection:**
- 输入框 Input：见 [`wenxin/components.md`](../wenxin/components.md) 表单规范 form spec
