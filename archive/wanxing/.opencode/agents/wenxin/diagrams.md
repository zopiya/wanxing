# 文心图解 (Wenxin Diagram) · Diagram & Knowledge Map (F8)

> Version: 2.0.0 | Date: 2026-05-24 | Wenxin F8
> This extension is subordinate to the canonical Wenxin design spec.

> 核心理念：将功能性的思维导图，升格为具备编辑质感的视觉读物。

F8 是正式输出形态。它交付的是图解本身，而不是文档站中的配图、幻灯片素材或海报视觉。
